...
<div class="row">
	...
	<div class="cell form-group col-md-6" data-name="menuicon">
		<label class="control-label" data-name="menuicon">{{translate 'menuicon' category='fields' scope='EntityManager'}}</label>
		<div class="field" data-name="menuicon">
			{{{menuicon}}}
		</div>
	</div>
...
<div class="row">
	...
	{{/if}}
	<div class="cell form-group col-md-6" data-name="isVisible">
		<label class="control-label" data-name="isVisible">{{translate 'isVisible' category='fields' scope='EntityManager'}}</label>
		<div class="field" data-name="isVisible">
			{{{isVisible}}}
		</div>
	</div>
	</div>
