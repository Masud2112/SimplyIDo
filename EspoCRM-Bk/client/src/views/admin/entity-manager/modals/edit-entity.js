    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            if (scope) {
                ...
                this.model.set('menuicon', this.translate(scope, 'scopeMenuIcon'));
                this.model.set('isVisible', this.translate(scope, 'scopeIsVisible'));
            ...
            this.createView('menuicon', 'views/fields/varchar', {
                model: model,
                mode: 'edit',
                el: this.options.el + ' .field[data-name="menuicon"]',
                defs: {
                    name: 'menuicon',
                    params: {
                        required: true,
            ...
            this.createView('isVisible', 'views/fields/enum', {
                    model: model,
                    mode: 'edit',
                    el: this.options.el + ' .field[data-name="isVisible"]',
                    defs: {
                        name: 'isVisible',
                        params: {
                            options: ['Yes', 'No']
        ...
        afterRender: function () {
            this.getView('name').on('change', function (m) {
                ...
                this.model.set('menuicon', name);
                this.model.set('isVisible', name);
        ...
        actionSave: function () {
            ...
            var data = {
                ...
                menuicon: this.model.get('menuicon'),
            ...
            $.ajax({
                ...
                (global.scopeMenuIcon || {})[name] = this.model.get('menuicon');
                (global.scopeIsVisible || {})[name] = this.model.get('isVisible');
