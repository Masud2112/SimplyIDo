    ...
    return Dep.extend({
        ...
        data: function () {
            return {
                ...
                userLogoSrc: this.getUserLogoSrc(),
        ...
        getUserLogoSrc: function () {
            var avatarId = this.getUser().attributes.avatarId;
            if (!avatarId) {
                return this.getBasePath() + ('client/img/default-user.png');
            }
            return this.getBasePath() + '?entryPoint=image&id=' + avatarId;
        },
        ...
        setupTabDefsList: function () {
            ...
            this.tabList.forEach(function (tab, i) {
               if (tab === '_delimiter_') {
                ...
                var menuicon = this.getLanguage().translate(tab, 'scopeMenuIcon');        
                var isVisible = this.getLanguage().translate(tab, 'scopeIsVisible');                        
                var o = {
                    link: '#' + tab,
                    label: label,
