...
class EntityManager
{
    ...
    public function create($name, $type, $params = array())
    {
        ...
        $menuicon = $name;
        if (!empty($params['menuicon'])) {
            $menuicon = $params['menuicon'];
        }
        $isVisible = $name;
        if (!empty($params['isVisible'])) {
        ...
        $scopesData['menuicon'] = $menuicon;
        $scopesData['isVisible'] = $isVisible;
        ...
        $this->getLanguage()->set('Global', 'scopeMenuIcon', $name, $menuicon);
        $this->getLanguage()->set('Global', 'scopeIsVisible', $name, $isVisible);
