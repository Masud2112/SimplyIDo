...
abstract class Base
{
    ...
    /**
     * Check if version of upgrade/extension is acceptable to current version of Simply I Do
     *
    ...
    protected function isAcceptable()
    {
        ...
        if (isset($manifest['acceptableVersions'])) {
            $res &= $this->checkVersions($manifest['acceptableVersions'], $this->getConfig()->get('version'), 'Your Simply I Do version doesn\'t match for this installation package.');
        }
