...
<head>
    ...
    if ($is_sido_admin == 0 && $is_admin == 0) {
        if (get_brand_option('favicon') != '') {
            ...
            <link href="<?php echo base_url('uploads/brands/round_' . get_brand_option('favicon')); ?>"
                  rel="shortcut icon">
            <?php
        } else {
    ...
    <link href='<?php echo base_url('assets/plugins/lightbox/css/lightbox.min.css?v=' . get_app_version()); ?>'
          rel='stylesheet'/>
    <!--- Slick slider -->
    <link href='<?php echo base_url('assets/plugins/slick/slick.css?v=' . get_app_version()); ?>' rel='stylesheet'/>
    <link href='<?php echo base_url('assets/plugins/slick/slick-theme.css?v=' . get_app_version()); ?>'
          rel='stylesheet'/>
