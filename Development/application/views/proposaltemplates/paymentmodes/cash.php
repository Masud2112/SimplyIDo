...
<div id="cash" class="tab-pane fade in col-sm-12">
    <div class="cell example example2">
        <?php echo form_open(site_url('proposal/payment'), array('id' => 'record_cashpayment_form', 'class' => 'record_payment_form')); ?>
        <div class="paymentPay_blk">
            <ul class="paymentPay_list_blk">
                <li class="cardDet_blk">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="cashfrom" class="form-control" type="text" required=""
                                   name="from" aria-describedby="basic-addon1"
                                   value="<?php echo get_addressbook_full_name($invoice->clientid) ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cashestimated">Estimated Payment Date</label>
                        <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon2">
                                                    <i class="fa fa-calendar" aria-hidden="true"></i>
                                                </span>
                            <input id="cashestimated" class="datepicker form-control" type="text"
                                   required="" name="estimated" aria-describedby="basic-addon2" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cashmessage">Message</label>
                        <div class="input-group">
                                                <textarea id="cashmessage" class="form-control" name="message"
                                                          rows="1"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <li class="totalPay_blk">
                        ...
                        <div class="totalPay_Det">
                            <div class="totalPay_input_blk">
                                    <ul class="totalPay_Input">
                                        ...
                                        <li>
                                        <!--<span class="form-control paymenttotal" contenteditable="true">$<?php /*echo $amount */ ?></span>-->
                            ...
                            <div class="payNow_blk">
                             ...
                             <div class="noteMsg"> <p><strong> <em>Please contact us to make payment arrangements.</em> </strong></p></div>
                        </div>
                    </div>
                    ...
                    <?php echo form_hidden('paymentmode', 'cash'); ?>
