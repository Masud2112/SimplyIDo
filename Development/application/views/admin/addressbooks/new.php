...
<script>
    ...
    $('body').on('click', '.address-add-more', function (e) {
        ...
        newaddressIn += '</select></div></div><div class="col-sm-8 col-xs-11"><div id="locationField" class="form-group"><label class="control-label" for="address">Address</label><input id="contact_' + index + '_autocomplete' + addressnext + '" class="form-control searchmap" data-addmap="' + addressnext + '" placeholder="Search Google Maps..." onfocus="geolocate()" type="text" data-index="' + index + '"></div><div class="customadd-btn"><div class="form-group"><button type="button" class="btn btn-info custom_address customadd-' + addressnext + '" data-addressid="' + addressnext + '" data-index="' + index + '">Custom</button></div></div></div><div class="col-sm-1 col-xs-1"><button id="addressremove-' + (addressnext) + '" class=" address-remove-me"><i class="fa fa-trash-o"></i></button></div></div>';
