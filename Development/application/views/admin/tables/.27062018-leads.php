...
foreach ($rResult as $aRow) {
    ...
    $leadname .= '<div class="lead-pimg">'.lead_profile_image($aRow['id'], array("lead-profile-image-small")).'</div><div class="lead-det"><div><a href="'.admin_url('leads/dashboard/'.$aRow['id']).'">'.$name.'</a></div>';
    $leadname .= "<div><i class='fa fa-tty'></i>".$aRow['eventtypename']."</div></div>";
    $row[] =  $leadname;

    $statuscontent = '<span class="leadstatuscolor" style="background-color:' . $aRow['color'] . ';"></span>';
