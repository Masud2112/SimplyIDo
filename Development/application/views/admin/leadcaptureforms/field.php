...
$x = 0;
?>
<li id ="field_<?php echo $qindex; ?>" draggable="true" class="field">
    <div class="form-group question">
        <input type="hidden" value="" name="order[]">
        <label for="<?php echo $question['questionid'] ?>" class="control-label question_type display-block">
            <span><?php echo isset($buttons[$question['boxtype']]) ? $buttons[$question['boxtype']] : _l('question_string') ?></span>
            ...
            <a href="javascript:void(0)" onclick="duplicate_question(<?php echo $question['questionid'] ?>,<?php echo $qindex; ?>)" class="pull-right"><i class="fa fa-files-o"></i></a>
            <!--<a href="javascript:void(0)"
