...
<script>
	...
	function render_li_items(finished, obj) {
		...
		return '<li class="todo_blk"><div class="dragger todo-dragger"></div> <input type="hidden" value="' + finished + '" name="finished"><input type="hidden" value="' + obj.item_order + '" name="todo_order"><div class="todocheck"><div class="checkbox checkbox-default todo-checkbox"><input type="checkbox" name="todo_id" value="' + obj.todoid + '" '+checked+'><label></label></div><div class="todo-description inline-block' + todo_finished_class + '">' + obj.description + '</div><small class="todo-date">' + obj.dateadded + '</small></div><div class="inline-block pull-right text-right ptop5 mright10"><a class="show_act" href="javascript:void(0)"><i class="fa fa-ellipsis-v" aria-hidden="true"></i></a></div><div class="table_actions"><ul><li><a href="#" onclick="delete_todo_item(this,' + obj.todoid + '); return false;" class="text-muted _delete "><i class="fa fa-remove"></i>Delete</a></li><li><a href="#" onclick="edit_todo_item('+obj.todoid+'); return false;" class="text-muted mright5"><i class="fa fa-pencil-square-o"></i>Edit</a></li></ul></div></li>';
	}
</script>
</body>
</html>
