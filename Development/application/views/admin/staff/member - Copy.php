...
<div class="content">
   <div class="row">
            ...
            <div class="panel-body">
               ...
               <div class="tab-content">
                  ...
                  <div role="tabpanel" class="tab-pane" id="tab_staff_permissions">
                     <div id="field">
                        <div class="form-group">
                           <?php $uselected = (isset($member) ? $member->user_type : ''); ?>
                           <?php echo render_select('user_type',$usertypes,array('id','type'),'staff_add_edit_user_type',$uselected); ?>
                        </div>
                        <div class="usertype-permission">
                           <?php if(isset($member)){ $pi = 0; ?>
                              <?php if(!empty($member->permission)){ ?>
                                 <?php foreach ($member->permission as $pk => $pv) { ?>
                                    <div id="field-<?php echo $pi; ?>">
                                       <div class="col-md-6">
                                          <label class="control-label" for="permission[<?php echo $pi; ?>][team]">Team</label>
                                          <select id="permission[<?php echo $pi; ?>][team]" name="permission[<?php echo $pi; ?>][team]" class="selectpicker" data-width="100%" data-none-selected-text="Select" data-live-search="true">
                                             <option value=""></option>
                                       ...
                                       <div class="col-md-6">
                                          <label class="control-label" for="permission[<?php echo $pi; ?>][role]">Role</label>
                                          <select id="permission[<?php echo $pi; ?>][role]" name="permission[<?php echo $pi; ?>][role]" class="selectpicker" data-width="100%" data-none-selected-text="Select" data-live-search="true">
                                             <option value=""></option>
                                             <?php
                                    ...
                                    <div class="col-md-12 text-right" style="margin-top:10px"><button id="remove<?php echo $pi; ?>" class="btn btn-danger remove-me">Remove</button></div>
                                 <?php $pi++; } ?>
                              <?php }else { ?>
                                 <div id="field-0">
                                 <div class="col-md-6">
                                    <label class="control-label" for="permission[0][team]">Team</label>
                                    <select id="permission[0][team]" name="permission[0][team]" class="selectpicker" data-width="100%" data-none-selected-text="Select" data-live-search="true">
                                       <option value=""></option>
                                 ...
                                 <div class="col-md-6">
                                    <label class="control-label" for="permission[0][role]">Role</label>
                                    <select id="permission[0][role]" name="permission[0][role]" class="selectpicker" data-width="100%" data-none-selected-text="Select" data-live-search="true">
                                       <option value=""></option>
                                       <?php
                                          foreach($roles as $role){
      ...
      <div class="btn-bottom-toolbar text-right btn-toolbar-container-out">
         ...
         <button class="btn btn-default" type="button" onclick="location.href='<?php echo base_url(); ?>admin/staff'"><?php echo _l( 'Cancel'); ?></button>
