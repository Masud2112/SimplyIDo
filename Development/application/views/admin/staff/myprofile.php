                    ...
                    <div class="panel-body">
                        ...
                        <div class="button-group mtop10 pull-right">
                            ...
                            <?php if (!empty($staff_p->linkedin)) { ?>
                                <a href="<?php echo $staff_p->linkedin; ?>" class="btn btn-default btn-icon"><i
                            ...
                            <h4>
                                ...
                                <?php if ($staff_p->last_activity && $staff_p->staffid != get_staff_user_id()) { ?>
                                    <small> - <?php echo _l('last_active'); ?>
                                        : <?php echo time_ago($staff_p->last_activity); ?></small>
                                <?php } ?>
                            </h4>
                            <p class="display-block"><i class="fa fa-envelope"></i> <a
