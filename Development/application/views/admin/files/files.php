...
?>
    <div id="wrapper">
        <div class="content files-page">
            ...
            <h1 class="pageTitleH1"><i class="fa fa-folder-open"></i><?php echo $title; ?></h1>
                    ...
                    <div class="col-md-12">
                        <div class="panel_s btmbrd">
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    <?php if ($this->session->has_userdata('files_kanban_view') && $this->session->userdata('files_kanban_view') == 'true') { ?>
                                            ...
                                            <?php foreach ($files as $file) {
                                                ...
                                                <tr>
                                                    <td data-order="<?php echo $file['file_name']; ?>">
                                                        <a href="<?php echo base_url($LeadFilePath); ?>"
                                                           data-lightbox="lead-attachment">
        ...
        <div class="panel_s btmbrd">
            <div class="panel-body">
                ...
                <div class="pull-right">
                    ...
                    <!--<a class="btn btn-primary filter_btn"><i class="fa fa-filter"></i></a>-->
                    <a href="<?php echo admin_url('files/switch_files_kanban/'); ?>"
                       class="btn btn-primary viewchangeBtn  <?php echo $list ?>">
                        <?php echo _l('switch_to_list_view'); ?>
                    </a>
                    <a href="<?php echo admin_url('files/switch_files_kanban/1'); ?>"
                       class="btn btn-primary viewchangeBtn  <?php echo $card ?>">
                        <?php echo _l('projects_switch_to_kanban'); ?>
                    </a>
                </div>
                <div class="clearfix"></div>
                                            ...
                                            <ul>
                                                <li>
                                                    <a data-toggle="tooltip" title="Delete"
                                                       ...
                                                       class="btn-icon _delete"><i class="fa fa-remove"></i>Delete</a>
                                                </li>
                                                <?php } ?>
                                                <li><a data-toggle="tooltip" title="Download"
                                                       href="<?php echo base_url($ProjectFilePath); ?>" download
                                                       class="btn-icon"><i class="fa fa-download"></i>Download</a></li>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        ...
                        <table class="table dt-table scroll-responsive table-leads-files table-striped"
                            ...
                            foreach ($files as $file) {
                                ...
                                if ($file['rel_type']== "project") {
                                    $ProjectFilePath = 'uploads/projects/' . $file['rel_id'] . '/' . $file['file_name'];
                                    $folder=PROJECT_ATTACHMENTS_FOLDER;
                                }else{
                                    $ProjectFilePath = 'uploads/leads/' . $file['rel_id'] . '/' . $file['file_name'];
                                    $folder = LEAD_ATTACHMENTS_FOLDER;
                                }
                                ...
                                <tr>
                                    <td data-order="<?php echo $file['file_name']; ?>">
                                        <a href="<?php echo base_url($ProjectFilePath); ?>" download>
                                            <?php if (is_image($folder . $eid . '/' . $file['file_name'])) { ?>
                                                <img src="<?php echo base_url($ProjectFilePath); ?>"
                                                     class="img img-responsive mright20 pull-left"
                                                     alt="<?php echo $file['file_name']; ?>" width="50">
                                                <span><?php echo $file['file_name']; ?></span>
                                    ...
                                    <td>
                                        <span><?php echo format_size(filesize($folder . $eid . '/' . $file['file_name'])); ?></span>
                                    </td>
                                    <td>
                                        <?php if ($file['staffid'] != 0) {
                                            $_data = '<a href="' . admin_url('staff/profile/' . $file['staffid']) . '">' . staff_profile_image($file['staffid'], array(
