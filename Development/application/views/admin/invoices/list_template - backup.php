 ...
 <div class="panel_s">
  ...
  <?php } ?>
    <div class="row invoice-filter-wrapper">
          ...
          <div class="col-md-3">              
                <select id="view_status" name="view_status" class="selectpicker" data-width="100%" data-live-search="true" data-none-selected-text="Status">
                   <option value=""></option>
          ...
          <div class="col-md-3">
              <input type="text" class="form-control" id="view_taskdate" name="view_taskdate" placeholder="Select Due Date" />
          </div>
          <div class="col-md-3">
             <!-- <select id="view_assigned" name="view_assigned" class="selectpicker" data-width="100%" data-live-search="true" data-none-selected-text="Assigned To">
                   <option value=""></option>
