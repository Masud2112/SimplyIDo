...
<div class="col-md-12 no-padding">
    ...
    <div class="pull-right">
        ...
        ?>
        <?php if (has_permission('invoices', '', 'edit') && empty($invoice->pslinvoice)) { ?>
            ...
            <div class="tab-content panel-body">
                                ...
                                <table class="table text-right">
                                 ...
                                 <td class="subtotal">
                                    ...
                                    <?php if (isset($proposal) && !empty($proposal->other) && $proposal->otherval > 0) { ?>
                                        <tr>
                                            <td>
                                                <span class="bold"><?php echo $proposal->other; ?></span>
                                            </td>
                                            <td class=" ">
                                                <?php echo format_money($proposal->otherval, $invoice->symbol); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <?php if($invoice->gratuity_percent > 0 && $invoice->gratuity_val > 0){ ?>
                                        <tr>
                                            <td><span class="bold"><?php echo _l('Gratuity'); ?><?php echo "(".$invoice->gratuity_percent."%)"; ?></span>
                                            </td>
                                            <td class="total">
                                                <?php echo format_money($invoice->gratuity_val,$invoice->symbol); ?>
                                            </td>
                                        </tr>
                                        <?php
                                        $invoice->total = $invoice->total+$invoice->gratuity_val;
                                    } ?>
                                    <tr>
                ...
                <div role="tabpanel" class="tab-pane" id="tab_reminders">
                    <?php if ($invoice->status == 1 || $invoice->status == 3) { ?>
                        <div class="duedatelbl pull-left mright10"><span class="due_lbl"><b>DUE : </b></span><span
