<?php init_head();?>
<div id="wrapper">
  <div class="content manage-expense-cateogry">
    <div class="row">
      <div class="col-md-12">
              <div class="breadcrumb">
                  ...
                  <i class="fa fa-angle-right breadcrumb-arrow"></i>
                  <span><?php echo _l('breadcrum_expense_category_label'); ?></span>
              </div>
          ...
          <div class="panel-body">
            <div class="_buttons">
              <?php if (has_permission('lists','','create')) { ?>
                <a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#expense_category_modal"><?php echo _l('add_expense_category_title'); ?></a>
              <?php } ?>
            </div>
            <div class="clearfix"></div>
  ...
  <div class="modal fade" id="expense_category_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <script>
    ...
    function edit_expense_category(invoker,id){
      var id = $(invoker).data('id');
      var name = $(invoker).data('name');
      var maincat = $(invoker).data('maincat');
      $('input[name=id]:hidden').val(id);
      $('#name').val(name);
      $("#expense_category_modal #myModalLabel").html('Edit Expense Category');
    }
    ...
    function manage_expense_category(form) {
      ...
      $.post(url, data).done(function(response) {
        ...
        if (response.success) {
          $('.table-expense-category').DataTable().ajax.reload();
    ...
    $(function(){
      ...
      initDataTable('.table-expense-category', window.location.href, [1], [1],'undefined',[0, "ASC" ]);
