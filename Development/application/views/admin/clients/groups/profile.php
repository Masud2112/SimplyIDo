<h4 class="customer-profile-group-heading hide"><?php echo _l('client_add_edit_profile'); ?></h4>
<div class="row">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="email" name="email" class="form-control" value="<?php echo $value; ?>" disabled="true">
