            ...
            <div class="quote_items_header <?php echo $class; ?>">
                <div class="row header">
                    ...
                    <div class="col-sm-7">
                        <?php }else{ ?>
                        <div class="col-sm-6">
                            <?php } ?><span class="nameTxt">Name</span></div>
                        ...
                        <div class="col-md-2 subtotal-col <?php //echo in_array('profit', $vcols)?'package_col visibility_visible':'package_col' ?>">
                            Subtotal
                        </div>
                ...
                <div class="quote_items">
                    ...
                    if (isset($quote_items) && count($quote_items) > 0) {
                        foreach ($quote_items as $key => $quote_item) {
                            ...
                            $this->load->view('admin/proposaltemplates/viewproposal/quote_item', $data);
                        }
                    }
                    ?>
                </div>
