		...
		<div class="gallery_header col-sm-12">
			...
			<div class="clearfix"></div>
				<div class="gal_images row">
					<div class="hrow"><span class="hTxt"><?php echo count($gallery)?> Items</span> <i class="fa fa-caret-up"></i></div>
					...
					<?php foreach ($gallery as $image) {
						...
						<div id="gal_image<?php echo $img_id?>" class="gal_image  image_<?php echo $img_id?>">
                            ...
                            <a href="<?php echo $url ?>" target="_blank">
                                ...
                                <span class="play_icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></span>
                            </a>
