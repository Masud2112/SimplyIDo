    ...
    <div id="contactinner">
        <div class="form-group contact-options">
            <div class="radio radio-primary radio-inline">
                <input id="contact_new_<?php echo $index; ?>" name="leadcontact[<?php echo $index; ?>]" value="new"
                       checked="true" type="radio" data-index="<?php echo $index; ?>">
                <label for="<?php echo _l('new_contact'); ?>"><?php echo _l('new_contact'); ?></label>
            </div>
            <div class="radio radio-primary radio-inline">
                <input id="contact_existing_<?php echo $index; ?>" name="leadcontact[<?php echo $index; ?>]" value="existing"
        ...
        <div id="existing-client-book-<?php echo $index; ?>" class="existing-client-book">
            <div class="panel-body">
                ...
                if (isset($clients)) {
                    ...
                    <select name='contact[<?php echo $index ?>][id]' class='selectpicker required clientselect clientselect_<?php echo $index ?>' data-index="<?php echo $index ?>" data-width="100%" data-none-selected-text="Select" data-live-search="true" aria-required="true" tabindex="-98">
                        <option value=""></option>
                        <?php foreach ($clients as $client){ ?>
                            <option value="<?php echo $client['addressbookid']?>" data-subtext="<?php echo $client['email']?>" <?php echo in_array($client['addressbookid'],$sclients)?"disabled":""?>>
        ...
        <?php if ($index > 0) { ?>
            <a href="javascript:void(0)" class="btn btn-danger pull-right removeContact"
