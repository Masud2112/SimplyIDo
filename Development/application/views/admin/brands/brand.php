                    ...
                    <div class="panel_s">
                        <div class="panel-body">
                            ...
                            <div class="form-group" data-name="brandname">
                                <label for="brand-name" class="control-label">
                                    <small class="req text-danger">*</small><?php echo _l('register_brand_name'); ?>
                                </label>
                                <input class="form-control" type="text"
                                       placeholder="<?php echo _l('register_brand_name'); ?>" name="brandname"
                                       id="brandname">
                      ...
                      <select class="form-control selectpicker" data-placeholder="<?php /*echo _l('register_brandtype'); */ ?>" name="brandtype" id="brandtype" data-none-selected-text="<?php /*echo _l('dropdown_non_selected_service'); */ ?>" data-live-search="true">
                          ...
                          */ ?>
                          ...
                          <?php
                            ...
                            <div class="form-group newbrandtypeList_blk" data-name="brandtype">
                                <div class="row">
                                    <?php foreach ($brandtypes as $brandtype) { ?>
                                        <div class="checkbox col-sm-6 col-md-4 col-xs-12">
                                            <input id="<?php echo $brandtype['brandtypeid']; ?>" name="brandtype[]"
                                                   type="checkbox" value="<?php echo $brandtype['brandtypeid']; ?>"
                                                   class="checkbox" required
                                                   data-parsley-required-message="<?php echo _l('Please select at least one checkbox'); ?>"/>
                                    ...
                                    <div class="checkbox col-sm-6 col-md-4 col-xs-12">
                                        <input id="other"
                                               ...
                                               value="other"
                                               class="checkbox"/>
                                        <label for="other" class="form-group">
                                            <input type="text" name="otherbrandval" placeholder="Other"
                                                   class="form-control">
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6" data-name="email">
                                    <label for="email" class="control-label">
                                        <?php echo _l('email'); ?>
                                    </label>
                                    <input class="form-control" type="email"
                                           placeholder="<?php echo _l('email'); ?>" name="email"
                                           id="email">
                                </div>
                                <div class="form-group col-sm-6" data-name="phone">
                                    <label for="phone"
                                           class="control-label"><?php echo _l('phone'); ?></label>
                                    <input class="form-control" type="tel"
                                           placeholder="<?php echo _l('phone'); ?>" name="phone"
                                           id="phone">
                                </div>
                            </div>

                            <div class="row">
                                <div class="form-group col-sm-6" data-name="address1">
                                    <label for="address1" class="control-label">
                                        <small class="req text-danger">*</small><?php echo _l('register_address1'); ?>
                                    </label>
                                    <input class="form-control" type="text"
                                           placeholder="<?php echo _l('register_address1'); ?>" name="address1"
                                           id="address1">
                                </div>
                                <div class="form-group col-sm-6" data-name="address2">
                                    <label for="address2"
                                           class="control-label"><?php echo _l('register_address2'); ?></label>
                                    <input class="form-control" type="text"
                                           placeholder="<?php echo _l('register_address2'); ?>" name="address2"
                                           id="address2">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" data-name="city">
                                        <label for="city" class="control-label">
                                            <small class="req text-danger">*</small><?php echo _l('register_city'); ?>
                                        </label>
                                        <input class="form-control" type="text"
                                               placeholder="<?php echo _l('register_city'); ?>" name="city" id="city">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" data-name="state">
                                        <label for="state" class="control-label">
                                            <small class="req text-danger">*</small><?php echo _l('register_state'); ?>
                                        </label>
                                        <input class="form-control" type="text"
                                               placeholder="<?php echo _l('register_state'); ?>" name="state"
                                               id="state">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" data-name="zipcode">
                                        <label for="zip-code" class="control-label">
                                            ...
                                            </small><?php echo _l('register_zipcode'); ?></label>
                                        <input class="form-control" type="text"
                                               placeholder="<?php echo _l('register_zipcode'); ?>" name="zipcode"
                                               id="zipcode">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" data-name="country">
                                        <label for="country" class="control-label">
                                            <small class="req text-danger">*
                                            </small><?php echo _l('register_country'); ?></label>
                            ...
                            <div class="form-group">
                                <div class="checkbox col-sm-6 col-md-4 col-xs-12">
                                    <input id="is_default"
                                           ...
                                           value=1
                                           class="checkbox"/>
                                    <label for="is_default" class="form-group"><?php echo _l('is_default') ?></label>
                                </div>
                            </div>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-default" type="button"
                                        onclick="location.href='<?php echo base_url(); ?>admin/'"><?php echo _l('Cancel'); ?></button>
                                <button class="btn btn-info" type="submit" id="frm-submit">
                                    <?php echo _l('create_brand'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
