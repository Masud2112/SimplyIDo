...
<script>
    ...
    $('body').on('click', '.phone-add-more', function (e) {
        ...
        newphoneIn += '<div class="col-sm-4 col-md-5 col-xs-10 multiphone"><div class="form-group"><label class="control-label" for="phone[' + phonenext + '][phone]">Phone</label><input id="contact[' + index + '][phone][' + phonenext + '][phone]" class="form-control" name="contact[' + index + '][phone][' + phonenext + '][phone]" autocomplete="off" value="" type="text"></div>';
        newphoneIn += '</div>';
