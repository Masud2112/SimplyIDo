...
<div class="questionnaire_buttons">
    <div class="hrow text-right pright15"><i class="fa fa-caret-up"></i></div>
    <div class="buttons_container rowWrap">
        <?php foreach ($buttons as $button){ ?>
            <div class="que_button text-center <?php echo $button['type'];?>" style="width:<?php echo $btn_width ?>%" onclick="add_question('<?php echo $button['type'];?>',<?php echo (isset($questionnaire) ? $questionnaire->id : '0'); ?>);return false;">
                <div class="btn_inner">
