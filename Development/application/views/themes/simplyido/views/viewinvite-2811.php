                      ...
                      <tr>
                        ...
                        <td id="accept-<?php echo $event['projectid']; ?><?php echo $event['inviteid']; ?>">
                          <?php if($invite_details->contacttype == 3) {?>
                            <?php if($event['status'] != 'Accepted by Vendor' && $event['status'] != 'Declined by Vendor') { ?>
                            ...
                            <?php } ?>
                            <?php if($event['status'] == 'Accepted by Vendor') { ?>
                              <i class="fa fa-2x fa-check" aria-hidden="true" style="color: #84c529;"></i>
                            <?php } ?>
                            <?php if($event['status'] == 'Declined by Vendor') { ?>
                              <i class="fa fa-2x fa-times" aria-hidden="true" style="color: #fc2d42;"></i>
                            <?php } ?>
                          <?php } ?>
                          <?php if($invite_details->contacttype == 4) {?>
                            <?php if($event['status'] != 'Accepted by Collaborator' && $event['status'] != 'Declined by Collaborator') { ?>
                              <button class="btn btn-info" onclick="fnAccept(<?php echo $event['projectid']; ?>,<?php echo $event['inviteid']; ?>,<?php echo $invite_details->contacttype; ?>);">Accept</button>
                              <a onclick="decline_invite(<?php echo $event['projectid']; ?>,<?php echo $event['inviteid']; ?>,<?php echo $invite_details->contacttype; ?>); return false;" class="btn btn-default">Decline</a>
                            <?php } ?>
                            <?php if($event['status'] == 'Accepted by Collaborator') { ?>
                              <i class="fa fa-2x fa-check" aria-hidden="true" style="color: #84c529;"></i>
                            <?php } ?>
                            <?php if($event['status'] == 'Declined by Collaborator') { ?>
                              <i class="fa fa-2x fa-times" aria-hidden="true" style="color: #fc2d42;"></i>
                            <?php } ?>
                          <?php } ?>
                          <?php if($invite_details->contacttype == 5) {?>
                            <?php if($event['status'] != 'Accepted by Venue Owner' && $event['status'] != 'Declined by Venue Owner') { ?>
                              <button class="btn btn-info" onclick="fnAccept(<?php echo $event['projectid']; ?>,<?php echo $event['inviteid']; ?>,<?php echo $invite_details->contacttype; ?>);">Accept</button>
                              <a onclick="decline_invite(<?php echo $event['projectid']; ?>,<?php echo $event['inviteid']; ?>,<?php echo $invite_details->contacttype; ?>); return false;" class="btn btn-default">Decline</a>
                            <?php } ?>
                            <?php if($event['status'] == 'Accepted by Venue Owner') { ?>
                              <i class="fa fa-2x fa-check" aria-hidden="true" style="color: #84c529;"></i>
                            <?php } ?>
                            <?php if($event['status'] == 'Declined by  Venue Owner') { ?>
                              <i class="fa fa-2x fa-times" aria-hidden="true" style="color: #fc2d42;"></i>
                            <?php } ?>
                          <?php } ?>
                        </td>
