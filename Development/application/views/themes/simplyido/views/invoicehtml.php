...
<div class="col-md-12 page-pdf-html-logo">
    <?php get_brand_logo('','pull-left',$invoice->brandid); ?>
    <?php if(is_staff_logged_in()){ ?>
    <a href="<?php echo admin_url(); ?>invoices/list_invoices<?php echo (isset($invoice->leadid) && $invoice->leadid != "" ? '?lid='.$invoice->leadid : '') ?>#<?php echo $invoice->id; ?>" class="btn btn-info pull-right"><?php echo _l('goto_admin_area'); ?></a> 
                        ...
                        <table class="table items">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo "Markup/Discount" ?></th>
               ...
               <div class="col-md-6 col-md-offset-6">
                <table class="table text-right">
                    <tbody>
                        ...
                        <?php } ?>
                        <?php if (isset($invoice->proposal) && !empty($invoice->proposal->other) && $invoice->proposal->otherval > 0) { ?>
                            <tr>
                                <td>
                                    <span class="bold"><?php echo $invoice->proposal->other; ?></span>
                                </td>
                                <td class=" ">
                                    <?php echo format_money($invoice->proposal->otherval, $invoice->symbol); ?>
                                </td>
                            </tr>
                        <?php } ?>
                        <?php
                        ...
                        if($gratuity_percent > 0 && $gratuity_val > 0){ ?>
                            <tr>
                                <td><span class="bold"><?php echo _l('Gratuity'); ?><?php echo "(".$gratuity_percent."%)"; ?></span>
                                </td>
                                <td class="total">
                                    <?php echo format_money($gratuity_val,$invoice->symbol); ?>
                                </td>
                            </tr>
                        <?php
                        ...
                        <tr>
                            <td><span class="bold"><?php echo _l('invoice_amount_due'); ?></span></td>
                            <td>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="pull-left"><?php echo format_money($payment['amount'],$invoice->symbol); ?></span>
                                <?php echo form_open($this->uri->uri_string()); ?>
