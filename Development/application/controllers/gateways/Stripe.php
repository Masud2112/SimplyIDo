...
class Stripe extends CI_Controller
{
    ...
    public function complete_purchase()
    {
        ...
        if ($this->input->post()) {
            ...
            $gratuity_percent = 0;
            $gratuity_val = 0;
            if (isset($data['gratuity_percent'])) {
                $gratuity_percent = $data['gratuity_percent'];
            }
            if (isset($data['gratuity_val'])) {
                $gratuity_val = $data['gratuity_val'];
            }

            unset($data['gratuity_percent']);
            unset($data['gratuity_val']);
            ...
            $pschedule = $data['pschedule'];
            unset($data['paymentid']);
            unset($data['pschedule']);
            ...
            if (!empty($oResponse->status)) {
                ...
                if ($oResponse->status == 'succeeded') {
                    ...
                    if ($success) {
                        ...
                        $this->paymentschedules_model->updatepayment($paymentid,$pschedule);
