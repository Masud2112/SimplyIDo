...
class Knowledge_base extends Admin_controller
{
    ...
    {
        if (!has_permission('knowledge_base', '', 'view', true)) {
    ...
    public function article($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                if (!has_permission('knowledge_base', '', 'create', true)) {
                    access_denied('knowledge_base');
                }
                ...
                if (!has_permission('knowledge_base', '', 'edit', true)) {
                    access_denied('knowledge_base');
                }
    ...
    {
        if (!has_permission('knowledge_base', '', 'delete', true)) {
            access_denied('knowledge_base');
        }
        if (!$id) {
