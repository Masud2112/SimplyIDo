...
class Utilities extends Admin_controller
{
    ...
    public function bulk_pdf_exporter()
    {
        ...
        $has_permission_estimates_view = has_permission('estimates', '', 'view', true);
        $has_permission_invoices_view  = has_permission('invoices', '', 'view', true);
        $has_permission_proposals_view = has_permission('proposals', '', 'view', true);
        $has_permission_payments_view  = has_permission('account_setup', '', 'view', true);
