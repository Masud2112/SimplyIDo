...
class Estimates extends Admin_controller
{
    ...
    {
        if (!has_permission('estimates', '', 'view', true) && !has_permission('estimates', '', 'view_own', true)) {
    ...
    public function estimate($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                if (!has_permission('estimates', '', 'edit', true)) {
                    access_denied('estimates');
                }
        ...
        if ($id == '') {
            ...
            if (!$estimate || (!has_permission('estimates', '', 'view', true) && $estimate->addedfrom != get_staff_user_id())) {
    ...
    {
        if (!has_permission('estimates', '', 'delete', true)) {
            access_denied('estimates');
        }
        if (!$id) {
            redirect(admin_url('estimates/list_estimates'));
