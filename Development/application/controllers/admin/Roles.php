...
class Roles extends Admin_controller
{
        ...
        if ($this->input->post()) {
            if ($id == '') {
                ...
                if ($id) {
                    ...
                    set_alert('danger', _l('problem_role_adding', _l('role_lowercase')));
                    redirect(admin_url('roles/role/' . $id));
                }
            } else {
                ...
                if ($success) {
                    ...
                    set_alert('danger', _l('problem_role_editing', _l('role_lowercase')));
                    redirect(admin_url('roles/role/' . $id));
                }
            }
        }
    ...
    public function delete($id)
    {
        ...
        if (is_array($response) && isset($response['referenced'])) {
            ...
            set_alert('danger', _l('problem_deleting', _l('role_lowercase')));
        }
        //redirect(admin_url('roles'));
    }
}
