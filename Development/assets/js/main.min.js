 ...
 * Added By : Masud
 * Dt : 06/24/2017
 * Init the Lead capture forms kanban
 */
function leadcaptureforms_kanban(search) {
    init_kanban('leadcaptureforms', '', '', 310, 360, '');
}
...
$('body').on('click', '.formtools .expand .fa', function (e) {
    $(this).toggleClass('fa-plus fa-angle-up');
    $(this).parent().siblings('.rowWrap').slideToggle();
